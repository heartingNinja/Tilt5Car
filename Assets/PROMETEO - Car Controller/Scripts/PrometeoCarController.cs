    ...
    void Update()
    {
        ...
        */
        ...
        else
        {
            ...
            //|| TiltFive.Input.TryGetButtonDown(TiltFive.Input.WandButton.One, out bool onePressed, TiltFive.ControllerIndex.Right, TiltFive.PlayerIndex.One)
            // || TiltFive.Input.TryGetButtonDown(TiltFive.Input.WandButton.Two, out bool twoPressed, TiltFive.ControllerIndex.Right, TiltFive.PlayerIndex.One)
            ...
            // Gas
            if (TiltFive.Input.TryGetTrigger( out float triggerDisplacement, TiltFive.ControllerIndex.Right, TiltFive.PlayerIndex.One))
            {          

                if(triggerDisplacement > 0)
                {              
            ...
            if (!Input.GetKey(KeyCode.S) && !Input.GetKey(KeyCode.W) && triggerDisplacement == 0 && !onePressed)
            {
                ThrottleOff();
            }


            if ((!Input.GetKey(KeyCode.S) && !Input.GetKey(KeyCode.W)) && !Input.GetKey(KeyCode.Space) && !deceleratingCar && triggerDisplacement == 0 && !onePressed)
            {
                InvokeRepeating("DecelerateCar", 0f, 0.1f);
                deceleratingCar = true;
            }
            if (!Input.GetKey(KeyCode.A) && !Input.GetKey(KeyCode.D) && steeringAxis != 0f && joystick.x == 0)
            {
                ResetSteeringAngle();
            }
